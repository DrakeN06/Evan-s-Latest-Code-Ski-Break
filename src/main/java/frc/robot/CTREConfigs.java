...
public final class CTREConfigs {
    ...
    public CTREConfigs(){
        ...
        /* Slot 0 Gains */
        armFXConfig.Slot0.kS = Constants.Arms.armKS;
        armFXConfig.Slot0.kV = Constants.Arms.armKV;
        armFXConfig.Slot0.kA = Constants.Arms.armKA;
        armFXConfig.Slot0.kP = Constants.Arms.armKP;
        armFXConfig.Slot0.kI = Constants.Arms.armKI;
        armFXConfig.Slot0.kD = Constants.Arms.armKD;

        /* Motion Magic Profiling */
        armFXConfig.MotionMagic.MotionMagicCruiseVelocity = Constants.Arms.motionMagicCruiseVelocity;
        armFXConfig.MotionMagic.MotionMagicAcceleration = Constants.Arms.motionMagicAcceleration;
        armFXConfig.MotionMagic.MotionMagicJerk = Constants.Arms.motionMagicMotionJerk;
    }
}